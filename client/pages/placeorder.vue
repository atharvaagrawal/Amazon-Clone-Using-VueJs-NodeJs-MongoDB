              ...
              <div class="a-box-inner">
                <div class="a-row a-spacing-micro">
                  <nuxt-link to="/payment">
                    <span class="a-button-place-order">Place your order in INR</span>
                  </nuxt-link>
                </div>
                ...
                <div class="a-row">
                  ...
                  <div class="order-summary" style="font-size: 12px;">
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">INR ₹{{getCartTotalPrice}}</div>
                    </div>
                    <div class="row">
                      <!-- Shipping cost -->
                      <div class="col-sm-6">Shipping & handling:</div>
                      <div class="col-sm-6 text-right">INR {{ shippingPrice }}</div>
                    </div>
                    <div class="row mt-2">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">INR {{getCartTotalPriceWithShipping}}</div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">Estimated tax to be collected:</div>
                      <div class="col-sm-6 text-right">INR 0.00</div>
                    </div>
                    <hr />
                    <div class="row">
                      <div class="col-sm-6">
                      ...
                      <div class="col-sm-6 text-right">
                        <!-- Total Price with Shipping -->
                        <div class="a-color-price a-size-medium a-text-bold">INR {{getCartTotalPriceWithShipping}}</div>
                      </div>
                    </div>
                  </div>
                </div>
