              ...
              <div class="row">
                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 text-left">
                  <div class="a-row">
                    ...
                    <br />
                    <span class="a-size-base a-text-bold a-color-secondary">Oct 01, 2020</span>
                  </div>
                </div>
              ...
              <div v-for="product in order.products" :key="product._id">
                ...
                <div class="row">
                  ...
                  <div class="col-xl-10 col-lg-10 col-10">
                    ...
                    <br />
                    <div class="a-row">
                      <nuxt-link  :to="`/products/${product.productID._id}`"  class="a-button-buy-again">Buy it again</nuxt-link>
                      <nuxt-link :to="`/products/${product.productID._id}`"  class="a-button-view-item">View your item </nuxt-link>
                    </div>
                  </div>
                </div>
              </div>
