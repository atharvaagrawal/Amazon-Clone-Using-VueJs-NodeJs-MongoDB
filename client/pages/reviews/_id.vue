          ...
          <div class="col-sm-8">
            <div class="a-spacing-top-medium">
              ...
              <div class="a-row a-spacing-top-large">
                ...
                <p style="font-size: 14px; font-weight: 700;">Shoppers find images and videos more helpful than text
                  alone.</p>
              </div>
              ...
              <div class="headline a-spacing-large">
                ...
                <input type="text" class="a-input-text" style="width: 70%;" placeholder="What's most important to know?"
                  v-model="headline" />
              </div>
              <!-- Body -->
